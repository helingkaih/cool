(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var NzTagComponent = /** @class */ (function () {
         ...
         * }
         */
        NzTagComponent.prototype.clearPresetColor = function () {
            var _b;
            var hostElement = this.elementRef.nativeElement;
            // /(ant-tag-(?:pink|red|...))/g
            var regexp = new RegExp("(ant-tag-(?:" + __spread(color.presetColors, color.statusColors).join('|') + "))", 'g');
            ...
            (_b = hostElement.classList).remove.apply(_b, __spread(matches));
        };
        /**
         * @deprecated
         * move to host after View Engine deprecation
         ...
         * }
         */
        NzTagComponent.prototype.setPresetColor = function () {
            var hostElement = this.elementRef.nativeElement;
            ...
            if (!this.nzColor) {
                ...
                this.isPresetColor = color.isPresetColor(this.nzColor) || color.isStatusColor(this.nzColor);
            }
