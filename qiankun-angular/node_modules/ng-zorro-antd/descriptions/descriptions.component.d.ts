...
export declare class NzDescriptionsComponent implements OnChanges, OnDestroy, AfterContentInit, OnInit {
    ...
    private getColumn;
    static ɵfac: ɵngcc0.ɵɵFactoryDef<NzDescriptionsComponent, [null, null, null, { optional: true; }]>;
    static ɵcmp: ɵngcc0.ɵɵComponentDefWithMeta<NzDescriptionsComponent, "nz-descriptions", ["nzDescriptions"], { "nzBordered": "nzBordered"; "nzLayout": "nzLayout"; "nzColumn": "nzColumn"; "nzSize": "nzSize"; "nzTitle": "nzTitle"; "nzColon": "nzColon"; "nzExtra": "nzExtra"; }, {}, ["items"], never>;
}
