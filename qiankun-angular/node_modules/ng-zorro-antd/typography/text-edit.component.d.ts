...
export declare class NzTextEditComponent implements OnInit, OnDestroy {
    ...
    static ɵcmp: ɵngcc0.ɵɵComponentDefWithMeta<NzTextEditComponent, "nz-text-edit", ["nzTextEdit"], { "icon": "icon"; "text": "text"; "tooltip": "tooltip"; }, { "startEditing": "startEditing"; "endEditing": "endEditing"; }, never, never>;
}
