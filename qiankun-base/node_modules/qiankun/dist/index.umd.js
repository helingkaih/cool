(function (global, factory) {
	      ...
	      while (1) {
	        switch (_context16.prev = _context16.next) {
	          case 0:
	            ...
	            _configuration$singul = configuration.singular, singular = _configuration$singul === void 0 ? false : _configuration$singul, _configuration$sandbo = configuration.sandbox, sandbox = _configuration$sandbo === void 0 ? true : _configuration$sandbo, excludeAssetFilter = configuration.excludeAssetFilter, importEntryOpts = _objectWithoutProperties(configuration, ["singular", "sandbox", "excludeAssetFilter"]); // get the entry html content and script executor
	...
	function loadMicroApp(app, configuration, lifeCycles) {
	  ...
	  return W(memorizedLoadingFn, _objectSpread({
	...
	function start() {
	  ...
	  var _frameworkConfigurati2 = frameworkConfiguration,
	      ...
	      importEntryOpts = _objectWithoutProperties(_frameworkConfigurati2, ["prefetch", "sandbox", "singular", "urlRerouteOnly"]);
